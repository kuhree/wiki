...
description: Running `docker` on MacOS is fun. This is because MacOS requires a Linux VM of some sort for to actually run the containers.
date: 2023-01-26
updated: 2025-02-09
tags:
  - tools/macos
...
Running `docker` on MacOS is _not_ fun. This is because MacOS (and probably Windows?) requires a Linux VM of some sort for it to actually run the containers.

House of cards? Shoulders of Giants?
